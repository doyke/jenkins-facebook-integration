...
namespace FHJ\ServiceProviders;
...
/*
 * This file originally was part of the FacebookServiceProvider but has been copied to this project
 * because there is a version clash with the fos/facebook-bundle and the author did not respond to my bug report.
 *
 * @see https://github.com/GromNaN/FacebookServiceProvider/blob/master/FacebookServiceProvider.php
 * @see https://github.com/GromNaN/FacebookServiceProvider/issues/4
 *
...
class FacebookServiceProvider implements ServiceProviderInterface
{
	...
	public function register(Application $app)
	{
		...
		$app['security.authentication_provider.facebook._proto'] = $app->protect(function ($name) use ($app)
		{
			...
			{
				return new FacebookServiceProvider(
					$name,
					$app['facebook'],
